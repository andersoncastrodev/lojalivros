...
import br.com.service.exceptions.DataIntegrityViolationException;
...
public class ControllerExceptionHandler {
    ...
    public ResponseEntity<StandardError> validationError(MethodArgumentNotValidException e, ServletRequest request){
    	ValidationError error = new ValidationError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erros na Validação dos Campos");
     
    	/*
    	 * Percorrendo os erros de Adicionando na Lista.
    	 */
